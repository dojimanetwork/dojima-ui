const Typography = {
  ...
  h5: {
    fontWeight: 600,
    fontSize: '1.5rem', // 24px secondary header
    letterSpacing: 'normal',
  ...
  body1: {
    fontWeight: 400,
    fontSize: '1rem', //16px primary font size
    lineHeight: 1.5, // 1.5 * 16 = 24
    letterSpacing: '0.00938em',
  },
  body2: {
    fontWeight: 400,
    fontSize: '0.875rem', //14px secondary font size
    lineHeight: 1.43,
    letterSpacing: '0.01071em',
  },
  caption: {
    fontWeight: 400,
    fontSize: '0.75rem', // 12px usefull for options
    lineHeight: 1.66,
